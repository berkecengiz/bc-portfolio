export function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center relative border-b-4 border-foreground">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="glass-light p-8 md:p-12 border-4 border-foreground">
